                ...
                <section class="grid grid-cols-2 gap-2">
                        ...
                        <section>
                            <ToggleGroup type="single" :model-value="filter" @update:model-value="handleToggleGroup"
                                ...
                                <ToggleGroupItem v-for="filter in filters" :key="filter.id" :value="filter.name"
                                    ...
                                    class="w-fit data-[state=on]:bg-[#04724D] data-[state=on]:text-white data-[state=on]:border-[#04724D] px-3 py-3 max-h-6 text-sm hover:bg-[#048B5F] hover:text-white transition-none border border-gray-700 hover:border-[#048B5F] text-gray-700 cursor-pointer rounded-full">
                                    {{ filter.name }}
                                </ToggleGroupItem>
                            </ToggleGroup>
                        </section>
                    ...
                    <div class="flex flex-col items-end lg:flex-row lg:justify-end gap-2">
                        ...
                        <section class="relative flex items-center">
                            <select
                                class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm font-medium border border-[#A1B2AD] rounded-lg pl-3 pr-8 py-1 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-[#04724D] appearance-none cursor-pointer">
                                <option value="brazil" class="">Departamento</option>
                        ...
                        <section class="relative flex items-center">
                            <select
                                class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm font-medium border border-[#A1B2AD] rounded-lg pl-3 pr-8 py-1 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-[#04724D] appearance-none cursor-pointer">
                                <option value="brazil" class="">Curso</option>
                                <option value="brazil" class="">Engenharia Mecanica</option>
                                <option value="bucharest">Bucharest</option>
                                <option value="london">London</option>
                                <option value="washington">Washington</option>
                            </select>
