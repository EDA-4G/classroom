                        ...
                        <Sheet>
                            ...
                            <SheetContent>
                                ...
                                <div class="grid gap-4 p-4">
                                    ...
                                    <!-- </a> -->
                                    <!-- <a href="#"> -->
                                    <!-- <h5 class="text-md font-semibold tracking-tight text-heading">
                                        Streamlining
                                        your
                                        design process today.</h5> -->

                                    <div>
                                        <h5 class="mb-1 text-lg font-semibold tracking-tight text-heading">
                                            Streamlining
                                            your
                                            design process today.</h5>
                                        <p class="text-xs">22 Jun 2025</p>
                                    ...
                                    <!-- <div
                                        ...
                                        <a href="#">
                                            <h5
                                                class="mt-4 lg:mt-6 mb-1 text-md font-semibold tracking-tight text-heading">
                                                Streamlining
                                                your
                                                design process today.</h5>
                                        </a>
                                    ...
                                    <div class="w-full pt-2 max-w-md">
                                        <!-- <p class="py-2 font-semibold">Compute Environment</p> -->
                                        <FieldGroup>
                                            <FieldSet>
                                                    ...
                                                    <FieldLabel for="vm-z4k"
                                                        ...
                                                        <Field orientation="horizontal">
                                                            <FieldContent class="gap-0">
                                                                ...
                                                                <FieldDescription>
                                                                    <!-- Está operação irá descontar MZN <span class="font-semibold">20,00</span> meticais. -->
                                                                    <!-- Discontar MZN <span class="font-semibold">20,00</span> meticais na conta. -->
