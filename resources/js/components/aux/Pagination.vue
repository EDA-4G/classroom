    ...
    <div class="flex justify-between items-center pt-4">
        ...
        <div class="flex space-x-1">
            ...
            <Link v-for="(page, index) in newLinks" :key="index" :href="page.url ?? ''"
                ...
                class="flex items-center px-3 py-1 min-w-10 min-h-10  text-sm font-normal border border-[#038043] bg-[#038043 rounded cursor-pointer transition duration-200 ease">
            {{ page.label }}</Link>
